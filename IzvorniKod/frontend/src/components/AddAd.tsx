...
function AddAd({ userData }: HomeProps) {
  ...
  const [disappearanceLocationLat, setDisappearanceLocationLat] = useState<
    number | null
  >(null);
  const [disappearanceLocationLng, setDisappearanceLocationLng] = useState<
    number | null
  >(null);
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      formData.append(
        ...
        disappearanceLocationLat.toString()
      );
      formData.append(
        "disappearanceLocationLng",
        disappearanceLocationLng.toString()
      );
      ...
      >
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="adPetCategory">
              ...
              <Dropdown onSelect={(eventKey) => handleCategoryChange(eventKey)}>
                <Dropdown.Toggle variant="light" id="dropdown-category">
                  {adCategory === "LJUBIMAC_JE_NESTAO_I_ZA_NJIM_SE_TRAGA" &&
                    "Ljubimac je nestao i za njim se traga"}
                  {adCategory === "U_SKLONISTU" && "U skloništu"}
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item eventKey="category1">
                    Ljubimac je nestao i za njim se traga
                  </Dropdown.Item>
                  <Dropdown.Item eventKey="category2">
                    U skloništu
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
          ...
          <Form.Group className="mb-3" controlId="adSpecies">
            ...
            <Form.Control
              type="text"
              placeholder="Upišite vrstu ljubimca"
          ...
          <Form.Group className="mb-3" controlId="adDateTime">
            <Form.Label>
              {adCategory === "U_SKLONISTU"
                ? "Odaberite datum i vrijeme pronalaska ljubimca"
                : "Odaberite datum i vrijeme nestanka ljubimca"}
            </Form.Label>
            <Form.Control
              type="datetime-local"
          ...
          <Form.Group className="mb-3" controlId="adColor">
            ...
            <Form.Control
              type="text"
              placeholder="Upišite boju ljubimca"
          ...
          <Form.Group className="mb-3" controlId="adDescription">
            ...
            <Form.Control
              as="textarea"
              rows={3}
              placeholder="Opišite ljubimca"
              onChange={handleDescriptionChange}
              value={adDescription}
            />
          </Form.Group>
          Odaberite slike koje želite dodati(prva slika koju dodate u nizu će
          biti naslovna slika):
